...
namespace LeroyMerlinClient
{
	public partial class MainWindow : Window
	{
		...
		private void MenuItem_Click_3(object sender, RoutedEventArgs e)
		{
			...
			SaveFileDialog fD = new SaveFileDialog { Filter = "Leroy Base (*.lmb)|*.lmb|All files (*.*)|*.*" };
		...
		private void MenuItem_Click_4(object sender, RoutedEventArgs e)
		{
			...
			OpenFileDialog fD = new OpenFileDialog { Filter = "Leroy Base (*.lmb)|*.lmb|All files (*.*)|*.*" };
			if (fD.ShowDialog() == true)
			{
		...
		//private Microsoft.Office.Interop.Excel.Workbooks excelappworkbooks;
		...
		private void MenuItem_Click_10(object sender, RoutedEventArgs e)
		{
			...
			System.Windows.Forms.OpenFileDialog ofd = new System.Windows.Forms.OpenFileDialog { Filter = "All files (*.*)|*.*" };
