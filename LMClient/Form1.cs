...
namespace Client
{
    public partial class Form1 : Form
    {
        ...
        Add_Client_Form f2 = new Add_Client_Form();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (File.Exists(Application.StartupPath + @"\yestoday.dlb"))
            {
                ...
                if (File.Exists(Application.StartupPath + @"\today2.dlb") && File.Exists(Application.StartupPath + @"\reboot.dlb"))
            {
