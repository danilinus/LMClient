...
namespace Messages
{
	...
	public partial class MainWindow : Window
	{
		...
		private readonly List<string> mes = new List<string>();
		private readonly List<bool> I = new List<bool>();
		private readonly List<SmmS> lblList = new List<SmmS>();
		string[] mesA;
		bool[] il;
		...
		private readonly BitmapImage haba = new BitmapImage();
		private readonly BitmapImage MF = new BitmapImage();
		...
		private void Window_Deactivated(object sender, EventArgs e) => fi = false;
